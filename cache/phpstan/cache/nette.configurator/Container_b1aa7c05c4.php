...
// source: phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level3.neon
...
class Container_b1aa7c05c4 extends _PHPStan_e140197a0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService061(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_b1aa7c05c4 $container)
			{
	...
	{
		return new PHPStan\Rules\IssetCheck($this->getService('0176'), $this->getService('0177'), false, true);
	}
	...
	public function createServiceContainer(): Container_b1aa7c05c4
	{
		return $this;
	}
