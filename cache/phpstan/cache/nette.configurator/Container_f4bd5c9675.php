...
// source: phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon
...
class Container_f4bd5c9675 extends _PHPStan_e140197a0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService061(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_f4bd5c9675 $container)
			{
	...
	{
		return new PHPStan\Rules\Properties\SetPropertyHookParameterRule($this->getService('0162'), true, false);
	}
	...
	public function createServiceContainer(): Container_f4bd5c9675
	{
		return $this;
	}
