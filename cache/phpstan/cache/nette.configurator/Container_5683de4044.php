...
class Container_5683de4044 extends _PHPStan_e140197a0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService061(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_5683de4044 $container)
			{
	...
	public function createServiceContainer(): Container_5683de4044
	{
		return $this;
	}
