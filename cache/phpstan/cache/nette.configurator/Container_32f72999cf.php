...
class Container_32f72999cf extends _PHPStan_e140197a0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService061(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_32f72999cf $container)
			{
	...
	public function createServiceContainer(): Container_32f72999cf
	{
		return $this;
	}
