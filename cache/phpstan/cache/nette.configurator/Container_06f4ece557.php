...
// source: phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level1.neon
...
class Container_06f4ece557 extends _PHPStan_e140197a0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService061(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_06f4ece557 $container)
			{
	...
	public function createServiceContainer(): Container_06f4ece557
	{
		return $this;
	}
