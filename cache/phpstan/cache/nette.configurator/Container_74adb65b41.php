<?php
// source: phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.neon
// source: phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level9.neon
// source: /home/jdlxt/__dev/repo/github-tools/phpstan.neon
// source: array
...
class Container_74adb65b41 extends _PHPStan_e140197a0\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.broker.methodsClassReflectionExtension' => ['0116' => true],
		'phpstan.broker.allowedSubTypesClassReflectionExtension' => ['0117' => true],
		'phpstan.broker.propertiesClassReflectionExtension' => ['0118' => true, '0282' => true],
	...
	protected $types = ['container' => '_PHPStan_e140197a0\Nette\DI\Container'];
	protected $aliases = [];

	protected $wiring = [
		'_PHPStan_e140197a0\Nette\DI\Container' => [['container']],
		'PHPStan\Rules\Rule' => [
			[
				'0141',
				'0142',
		...
		'PHPStan\Rules\Cast\EchoRule' => [['rules.114']],
		'PHPStan\Rules\Cast\InvalidCastRule' => [['rules.115']],
		'PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule' => [['rules.116']],
		'PHPStan\Rules\Cast\PrintRule' => [['rules.117']],
		'PHPStan\Rules\Classes\AccessPrivateConstantThroughStaticRule' => [['rules.118']],
		'PHPStan\Rules\Classes\MethodTagRule' => [['rules.119']],
		'PHPStan\Rules\Classes\MethodTagTraitRule' => [['rules.120']],
		'PHPStan\Rules\Classes\MethodTagTraitUseRule' => [['rules.121']],
		'PHPStan\Rules\Classes\PropertyTagRule' => [['rules.122']],
		'PHPStan\Rules\Classes\PropertyTagTraitRule' => [['rules.123']],
		'PHPStan\Rules\Classes\PropertyTagTraitUseRule' => [['rules.124']],
		'PHPStan\Rules\Classes\MixinTraitRule' => [['rules.125']],
		'PHPStan\Rules\Classes\MixinTraitUseRule' => [['rules.126']],
		'PHPStan\Rules\Comparison\UsageOfVoidMatchExpressionRule' => [['rules.127']],
		'PHPStan\Rules\Constants\ValueAssignedToClassConstantRule' => [['rules.128']],
		'PHPStan\Rules\Functions\IncompatibleDefaultParameterTypeRule' => [['rules.129']],
		'PHPStan\Rules\Functions\IncompatibleArrowFunctionDefaultParameterTypeRule' => [['rules.130']],
		'PHPStan\Rules\Functions\IncompatibleClosureDefaultParameterTypeRule' => [['rules.131']],
		'PHPStan\Rules\Generics\ClassAncestorsRule' => [['rules.132']],
		'PHPStan\Rules\Generics\ClassTemplateTypeRule' => [['rules.133']],
		'PHPStan\Rules\Generics\EnumAncestorsRule' => [['rules.134']],
		'PHPStan\Rules\Generics\EnumTemplateTypeRule' => [['rules.135']],
		'PHPStan\Rules\Generics\FunctionTemplateTypeRule' => [['rules.136']],
		'PHPStan\Rules\Generics\FunctionSignatureVarianceRule' => [['rules.137']],
		'PHPStan\Rules\Generics\InterfaceAncestorsRule' => [['rules.138']],
		'PHPStan\Rules\Generics\InterfaceTemplateTypeRule' => [['rules.139']],
		'PHPStan\Rules\Generics\MethodTemplateTypeRule' => [['rules.140']],
		'PHPStan\Rules\Generics\MethodTagTemplateTypeRule' => [['rules.141']],
		'PHPStan\Rules\Generics\MethodTagTemplateTypeTraitRule' => [['rules.142']],
		'PHPStan\Rules\Generics\MethodSignatureVarianceRule' => [['rules.143']],
		'PHPStan\Rules\Generics\PropertyVarianceRule' => [['rules.144']],
		'PHPStan\Rules\Generics\TraitTemplateTypeRule' => [['rules.145']],
		'PHPStan\Rules\Generics\UsedTraitsRule' => [['rules.146']],
		'PHPStan\Rules\Methods\CallPrivateMethodThroughStaticRule' => [['rules.147']],
		'PHPStan\Rules\Methods\IncompatibleDefaultParameterTypeRule' => [['rules.148']],
		'PHPStan\Rules\Operators\InvalidBinaryOperationRule' => [['rules.149']],
		'PHPStan\Rules\Operators\InvalidComparisonOperationRule' => [['rules.150']],
		'PHPStan\Rules\Operators\InvalidUnaryOperationRule' => [['rules.151']],
		'PHPStan\Rules\PhpDoc\FunctionConditionalReturnTypeRule' => [['rules.152']],
		'PHPStan\Rules\PhpDoc\MethodConditionalReturnTypeRule' => [['rules.153']],
		'PHPStan\Rules\PhpDoc\FunctionAssertRule' => [['rules.154']],
		'PHPStan\Rules\PhpDoc\MethodAssertRule' => [['rules.155']],
		'PHPStan\Rules\PhpDoc\IncompatibleSelfOutTypeRule' => [['rules.156']],
		'PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule' => [['rules.157']],
		'PHPStan\Rules\PhpDoc\IncompatiblePhpDocTypeRule' => [['rules.158']],
		'PHPStan\Rules\PhpDoc\IncompatiblePropertyHookPhpDocTypeRule' => [['rules.159']],
		'PHPStan\Rules\PhpDoc\IncompatiblePropertyPhpDocTypeRule' => [['rules.160']],
		'PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule' => [['rules.161']],
		'PHPStan\Rules\PhpDoc\IncompatibleParamImmediatelyInvokedCallableRule' => [['rules.162']],
		'PHPStan\Rules\PhpDoc\VarTagChangedExpressionTypeRule' => [['rules.163']],
		'PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule' => [['rules.164']],
		'PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule' => [['rules.165']],
		'PHPStan\Rules\Classes\RequireImplementsRule' => [['rules.166']],
		'PHPStan\Rules\Classes\RequireExtendsRule' => [['rules.167']],
		'PHPStan\Rules\PhpDoc\RequireImplementsDefinitionClassRule' => [['rules.168']],
		'PHPStan\Rules\PhpDoc\RequireExtendsDefinitionClassRule' => [['rules.169']],
		'PHPStan\Rules\PhpDoc\RequireExtendsDefinitionTraitRule' => [['rules.170']],
		'PHPStan\Rules\Pure\PureFunctionRule' => [['rules.171']],
		'PHPStan\Rules\Pure\PureMethodRule' => [['rules.172']],
		'PHPStan\Rules\Arrays\ArrayDestructuringRule' => [['rules.173']],
		'PHPStan\Rules\Arrays\ArrayUnpackingRule' => [['rules.174']],
		'PHPStan\Rules\Arrays\IterableInForeachRule' => [['rules.175']],
		'PHPStan\Rules\Arrays\OffsetAccessAssignmentRule' => [['rules.176']],
		'PHPStan\Rules\Arrays\OffsetAccessAssignOpRule' => [['rules.177']],
		'PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule' => [['rules.178']],
		'PHPStan\Rules\Arrays\UnpackIterableInArrayRule' => [['rules.179']],
		'PHPStan\Rules\Exceptions\ThrowExprTypeRule' => [['rules.180']],
		'PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule' => [['rules.181']],
		'PHPStan\Rules\Functions\ClosureReturnTypeRule' => [['rules.182']],
		'PHPStan\Rules\Functions\ReturnTypeRule' => [['rules.183']],
		'PHPStan\Rules\Generators\YieldTypeRule' => [['rules.184']],
		'PHPStan\Rules\Methods\ReturnTypeRule' => [['rules.185']],
		'PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule' => [['rules.186']],
		'PHPStan\Rules\Properties\GetNonVirtualPropertyHookReadRule' => [['rules.187']],
		'PHPStan\Rules\Properties\ReadOnlyPropertyAssignRule' => [['rules.188']],
		'PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRule' => [['rules.189']],
		'PHPStan\Rules\Properties\ReadOnlyPropertyAssignRefRule' => [['rules.190']],
		'PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRefRule' => [['rules.191']],
		'PHPStan\Rules\Properties\SetNonVirtualPropertyHookAssignRule' => [['rules.192']],
		'PHPStan\Rules\Properties\TypesAssignedToPropertiesRule' => [['rules.193']],
		'PHPStan\Rules\Variables\ParameterOutAssignedTypeRule' => [['rules.194']],
		'PHPStan\Rules\Variables\ParameterOutExecutionEndTypeRule' => [['rules.195']],
		'PHPStan\Rules\Variables\VariableCloningRule' => [['rules.196']],
		'PHPStan\Rules\Arrays\DeadForeachRule' => [['rules.197']],
		'PHPStan\Rules\DeadCode\CallToConstructorStatementWithoutImpurePointsRule' => [['rules.198']],
		'PHPStan\Rules\DeadCode\CallToFunctionStatementWithoutImpurePointsRule' => [['rules.199']],
		'PHPStan\Rules\DeadCode\CallToMethodStatementWithoutImpurePointsRule' => [['rules.200']],
		'PHPStan\Rules\DeadCode\CallToStaticMethodStatementWithoutImpurePointsRule' => [['rules.201']],
		'PHPStan\Rules\DeadCode\NoopRule' => [['rules.202']],
		'PHPStan\Rules\DeadCode\UnreachableStatementRule' => [['rules.203']],
		'PHPStan\Rules\DeadCode\UnusedPrivateConstantRule' => [['rules.204']],
		'PHPStan\Rules\DeadCode\UnusedPrivateMethodRule' => [['rules.205']],
		'PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule' => [['rules.206']],
		'PHPStan\Rules\Functions\CallToFunctionStatementWithoutSideEffectsRule' => [['rules.207']],
		'PHPStan\Rules\Functions\UselessFunctionReturnValueRule' => [['rules.208']],
		'PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule' => [['rules.209']],
		'PHPStan\Rules\Methods\CallToMethodStatementWithoutSideEffectsRule' => [['rules.210']],
		'PHPStan\Rules\Methods\CallToStaticMethodStatementWithoutSideEffectsRule' => [['rules.211']],
		'PHPStan\Rules\Methods\NullsafeMethodCallRule' => [['rules.212']],
		'PHPStan\Rules\TooWideTypehints\TooWideArrowFunctionReturnTypehintRule' => [['rules.213']],
		'PHPStan\Rules\TooWideTypehints\TooWideClosureReturnTypehintRule' => [['rules.214']],
		'PHPStan\Rules\TooWideTypehints\TooWideFunctionReturnTypehintRule' => [['rules.215']],
		'PHPStan\Rules\TooWideTypehints\TooWideFunctionParameterOutTypeRule' => [['rules.216']],
		'PHPStan\Rules\TooWideTypehints\TooWideMethodParameterOutTypeRule' => [['rules.217']],
		'PHPStan\Rules\TooWideTypehints\TooWidePropertyTypeRule' => [['rules.218']],
		'PHPStan\Rules\Traits\NotAnalysedTraitRule' => [['rules.219']],
		'PHPStan\Rules\DateTimeInstantiationRule' => [['rules.220']],
		'PHPStan\Rules\Functions\CallUserFuncRule' => [['rules.221']],
		'PHPStan\Rules\Functions\ParameterCastableToStringRule' => [['rules.222']],
		'PHPStan\Rules\Functions\ImplodeParameterCastableToStringRule' => [['rules.223']],
		'PHPStan\Rules\Functions\SortParameterCastableToStringRule' => [['rules.224']],
		'PHPStan\Rules\Regexp\RegularExpressionQuotingRule' => [['rules.225']],
		'PHPStan\Rules\Constants\MissingClassConstantTypehintRule' => [['rules.226']],
		'PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule' => [['rules.227']],
		'PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule' => [['rules.228']],
		'PHPStan\Rules\Methods\MissingMethodParameterTypehintRule' => [['rules.229']],
		'PHPStan\Rules\Methods\MissingMethodReturnTypehintRule' => [['rules.230']],
		'PHPStan\Rules\Methods\MissingMethodSelfOutTypeRule' => [['rules.231']],
		'PHPStan\Rules\Properties\MissingPropertyTypehintRule' => [['rules.232']],
		...
		'PHPStan\Reflection\MethodsClassReflectionExtension' => [['096', '0110', '0112', '0114', '0116']],
		'PHPStan\Reflection\Annotations\AnnotationsMethodsClassReflectionExtension' => [['096']],
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [['097', '0111', '0113', '0114', '0118', '0282']],
		...
		'PHPStan\Type\DynamicStaticMethodReturnTypeExtension' => [['0222', '0225', '0227', '0240', '0346', '0352']],
		...
		'PHPStan\Rules\Classes\MixinRule' => [['0383']],
		'PHPStan\Rules\PhpDoc\RequireExtendsCheck' => [['0384']],
		'PHPStan\Rules\PhpDoc\RequireImplementsDefinitionTraitRule' => [['0385']],
		'PHPStan\Rules\Functions\CallCallablesRule' => [['0386']],
		'PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule' => [['0387']],
		'PHPStan\Rules\PhpDoc\InvalidPhpDocVarTagTypeRule' => [['0388']],
		'PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule' => [['0389']],
		'PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule' => [['0390']],
		'PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule' => [['0391']],
		'PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule' => [['0392']],
		'PHPStan\Rules\Exceptions\ThrowsVoidFunctionWithExplicitThrowPointRule' => [['0393']],
		'PHPStan\Rules\Exceptions\ThrowsVoidMethodWithExplicitThrowPointRule' => [['0394']],
		'PHPStan\Rules\Exceptions\ThrowsVoidPropertyHookWithExplicitThrowPointRule' => [['0395']],
		'PHPStan\Rules\Generators\YieldFromTypeRule' => [['0396']],
		'PHPStan\Rules\Generators\YieldInGeneratorRule' => [['0397']],
		'PHPStan\Rules\Classes\ImpossibleInstanceOfRule' => [['0398']],
		'PHPStan\Rules\Comparison\BooleanAndConstantConditionRule' => [['0399']],
		'PHPStan\Rules\Comparison\BooleanOrConstantConditionRule' => [['0400']],
		'PHPStan\Rules\Comparison\BooleanNotConstantConditionRule' => [['0401']],
		'PHPStan\Collectors\Collector' => [['0402', '0403', '0404', '0405', '0406', '0407', '0408', '0429', '0430']],
		'PHPStan\Rules\DeadCode\ConstructorWithoutImpurePointsCollector' => [['0402']],
		'PHPStan\Rules\DeadCode\PossiblyPureNewCollector' => [['0403']],
		'PHPStan\Rules\DeadCode\FunctionWithoutImpurePointsCollector' => [['0404']],
		'PHPStan\Rules\DeadCode\PossiblyPureFuncCallCollector' => [['0405']],
		'PHPStan\Rules\DeadCode\MethodWithoutImpurePointsCollector' => [['0406']],
		'PHPStan\Rules\DeadCode\PossiblyPureMethodCallCollector' => [['0407']],
		'PHPStan\Rules\DeadCode\PossiblyPureStaticCallCollector' => [['0408']],
		'PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule' => [['0409']],
		'PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule' => [['0410']],
		'PHPStan\Rules\Comparison\ElseIfConstantConditionRule' => [['0411']],
		'PHPStan\Rules\Comparison\IfConstantConditionRule' => [['0412']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule' => [['0413']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule' => [['0414']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule' => [['0415']],
		'PHPStan\Rules\Comparison\LogicalXorConstantConditionRule' => [['0416']],
		'PHPStan\Rules\Comparison\MatchExpressionRule' => [['0417']],
		'PHPStan\Rules\Comparison\NumberComparisonOperatorsConstantConditionRule' => [['0418']],
		'PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule' => [['0419']],
		'PHPStan\Rules\Comparison\ConstantLooseComparisonRule' => [['0420']],
		'PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule' => [['0421']],
		'PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule' => [['0422']],
		'PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule' => [['0423']],
		'PHPStan\Rules\Exceptions\TooWideFunctionThrowTypeRule' => [['0424']],
		'PHPStan\Rules\Exceptions\TooWideMethodThrowTypeRule' => [['0425']],
		'PHPStan\Rules\Exceptions\TooWidePropertyHookThrowTypeRule' => [['0426']],
		'PHPStan\Rules\TooWideTypehints\TooWideMethodReturnTypehintRule' => [['0427']],
		'PHPStan\Rules\Properties\NullsafePropertyFetchRule' => [['0428']],
		'PHPStan\Rules\Traits\TraitDeclarationCollector' => [['0429']],
		'PHPStan\Rules\Traits\TraitUseCollector' => [['0430']],
		'PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule' => [['0431']],
		...
		'PHPStan\Rules\Functions\ParameterCastableToNumberRule' => [['0435']],
	];
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(null, ['/home/jdlxt/.config/composer']);
	}


	public function createService029(): PHPStan\Php\ComposerPhpVersionFactory
	{
		return new PHPStan\Php\ComposerPhpVersionFactory(['/home/jdlxt/.config/composer']);
	}
	...
	public function createService045(): PHPStan\PhpDoc\DefaultStubFilesProvider
	{
		return new PHPStan\PhpDoc\DefaultStubFilesProvider(
			$this->getService('074'),
			[
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionAttribute.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionClassConstant.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionFunctionAbstract.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionMethod.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionParameter.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/ReflectionProperty.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/iterable.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/ArrayObject.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/WeakReference.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/ext-ds.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/ImagickPixel.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/PDOStatement.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/date.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/ibm_db2.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/mysqli.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/zip.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/dom.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/spl.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/SplObjectStorage.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/Exception.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/arrayFunctions.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/core.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/typeCheckingFunctions.stub',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/Countable.stub',
			],
			['/home/jdlxt/.config/composer']
		);
	}
	...
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper($this->getService('084'), [], true);
	}
	...
	public function createService061(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_74adb65b41 $container)
			{
			...
			public function create(): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/home/jdlxt/__dev/repo/github-tools/cache/phpstan/resultCache.php',
					$this->container->getParameter('analysedPaths'),
					['/home/jdlxt/.config/composer'],
					'9',
					null,
					[
						'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
						'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionAttribute.php',
						'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/Attribute.php',
						'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionIntersectionType.php',
					],
					[],
					[],
					false
	...
	{
		return new PHPStan\Analyser\ResultCache\ResultCacheClearer('/home/jdlxt/__dev/repo/github-tools/cache/phpstan/resultCache.php');
	}
	...
	public function createService069(): PHPStan\Command\FixerApplication
	{
		return new PHPStan\Command\FixerApplication(
			...
			'/home/jdlxt/__dev/repo/github-tools',
			($this->getParameter('sysGetTempDir')) . '/phpstan-fixer',
			['1.1.1.2'],
			['/home/jdlxt/.config/composer'],
			[
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/parametersSchema.neon',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level9.neon',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level7.neon',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level5.neon',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level4.neon',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level3.neon',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level2.neon',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level1.neon',
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level0.neon',
				'/home/jdlxt/__dev/repo/github-tools/phpstan.neon',
			],
			null,
			[
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/stubs/runtime/ReflectionUnionType.php',
	...
	public function createService076(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			'/home/jdlxt/__dev/repo/github-tools',
			'/home/jdlxt/__dev/repo/github-tools/cache/phpstan',
			[
				'phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level9.neon',
				'/home/jdlxt/__dev/repo/github-tools/phpstan.neon',
			],
	...
	{
		return new PHPStan\File\FileHelper('/home/jdlxt/__dev/repo/github-tools');
	}
	...
	public function createService085(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			$this->getService('086'),
			['analyseAndScan' => ['/home/jdlxt/__dev/repo/github-tools/php/vendor'], 'analyse' => []]
		);
	}
	...
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchCheck($this->getService('0179'), true, false, false);
	}
	...
	{
		return new PHPStan\Rules\Comparison\ConstantConditionRuleHelper($this->getService('0139'), true);
	}
	...
	{
		return new PHPStan\Rules\IssetCheck($this->getService('0176'), $this->getService('0177'), true, true);
	}
	...
	{
		return new PHPStan\Rules\RuleLevelHelper($this->getService('reflectionProvider'), true, false, true, true, false, false);
	}
	...
	{
		return new PHPStan\Rules\Properties\SetPropertyHookParameterRule($this->getService('0162'), true, true);
	}
	...
	{
		return new PHPStan\Rules\Keywords\RequireFileExistsRule('/home/jdlxt/__dev/repo/github-tools');
	}


	public function createService0383(): PHPStan\Rules\Classes\MixinRule
	{
		return new PHPStan\Rules\Classes\MixinRule($this->getService('0136'));
	}


	public function createService0384(): PHPStan\Rules\PhpDoc\RequireExtendsCheck
	{
		return new PHPStan\Rules\PhpDoc\RequireExtendsCheck($this->getService('0131'), true);
	}


	public function createService0385(): PHPStan\Rules\PhpDoc\RequireImplementsDefinitionTraitRule
	{
	...
	public function createService0386(): PHPStan\Rules\Functions\CallCallablesRule
	{
		return new PHPStan\Rules\Functions\CallCallablesRule($this->getService('0146'), $this->getService('0179'), true);
	}


	public function createService0387(): PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule($this->getService('031'), $this->getService('034'));
	}


	public function createService0388(): PHPStan\Rules\PhpDoc\InvalidPhpDocVarTagTypeRule
	{
	...
	public function createService0389(): PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule($this->getService('031'), $this->getService('034'));
	}


	public function createService0390(): PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule($this->getService('0179'), true);
	}


	public function createService0391(): PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule(true);
	}


	public function createService0392(): PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule($this->getService('0179'), $this->getService('0130'), true);
	}


	public function createService0393(): PHPStan\Rules\Exceptions\ThrowsVoidFunctionWithExplicitThrowPointRule
	{
	...
	public function createService0394(): PHPStan\Rules\Exceptions\ThrowsVoidMethodWithExplicitThrowPointRule
	{
	...
	public function createService0395(): PHPStan\Rules\Exceptions\ThrowsVoidPropertyHookWithExplicitThrowPointRule
	{
	...
	public function createService0396(): PHPStan\Rules\Generators\YieldFromTypeRule
	{
		return new PHPStan\Rules\Generators\YieldFromTypeRule($this->getService('0179'), true);
	}


	public function createService0397(): PHPStan\Rules\Generators\YieldInGeneratorRule
	{
		return new PHPStan\Rules\Generators\YieldInGeneratorRule(true);
	}


	public function createService0398(): PHPStan\Rules\Classes\ImpossibleInstanceOfRule
	{
		return new PHPStan\Rules\Classes\ImpossibleInstanceOfRule(true, false, true);
	}


	public function createService0399(): PHPStan\Rules\Comparison\BooleanAndConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanAndConstantConditionRule($this->getService('0138'), true, false, true);
	}


	public function createService0400(): PHPStan\Rules\Comparison\BooleanOrConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanOrConstantConditionRule($this->getService('0138'), true, false, true);
	}


	public function createService0401(): PHPStan\Rules\Comparison\BooleanNotConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanNotConstantConditionRule($this->getService('0138'), true, false, true);
	}


	public function createService0402(): PHPStan\Rules\DeadCode\ConstructorWithoutImpurePointsCollector
	{
	...
	public function createService0404(): PHPStan\Rules\DeadCode\FunctionWithoutImpurePointsCollector
	{
		return new PHPStan\Rules\DeadCode\FunctionWithoutImpurePointsCollector;
	}


	public function createService0405(): PHPStan\Rules\DeadCode\PossiblyPureFuncCallCollector
	{
		return new PHPStan\Rules\DeadCode\PossiblyPureFuncCallCollector($this->getService('reflectionProvider'));
	}


	public function createService0406(): PHPStan\Rules\DeadCode\MethodWithoutImpurePointsCollector
	{
		return new PHPStan\Rules\DeadCode\MethodWithoutImpurePointsCollector;
	}


	public function createService0407(): PHPStan\Rules\DeadCode\PossiblyPureMethodCallCollector
	{
		return new PHPStan\Rules\DeadCode\PossiblyPureMethodCallCollector;
	}


	public function createService0408(): PHPStan\Rules\DeadCode\PossiblyPureStaticCallCollector
	{
		return new PHPStan\Rules\DeadCode\PossiblyPureStaticCallCollector;
	}


	public function createService0409(): PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule($this->getService('0175'), [], [], false);
	}


	public function createService0410(): PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\DoWhileLoopConstantConditionRule($this->getService('0138'), true, true);
	}


	public function createService0411(): PHPStan\Rules\Comparison\ElseIfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\ElseIfConstantConditionRule($this->getService('0138'), true, false, true);
	}


	public function createService0412(): PHPStan\Rules\Comparison\IfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\IfConstantConditionRule($this->getService('0138'), true, true);
	}


	public function createService0413(): PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule($this->getService('0139'), true, false, true);
	}


	public function createService0414(): PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule($this->getService('0139'), true, false, true);
	}


	public function createService0415(): PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule($this->getService('0139'), true, false, true);
	}


	public function createService0416(): PHPStan\Rules\Comparison\LogicalXorConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\LogicalXorConstantConditionRule($this->getService('0138'), true, false, true);
	}


	public function createService0417(): PHPStan\Rules\Comparison\MatchExpressionRule
	{
		return new PHPStan\Rules\Comparison\MatchExpressionRule($this->getService('0138'), false, true);
	}


	public function createService0418(): PHPStan\Rules\Comparison\NumberComparisonOperatorsConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\NumberComparisonOperatorsConstantConditionRule(true, true);
	}


	public function createService0419(): PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule
	{
		return new PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule($this->getService('063'), true, false, true);
	}
	...
	public function createService0421(): PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule($this->getService('0138'), true, true);
	}


	public function createService0422(): PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysFalseConditionRule($this->getService('0138'), true, true);
	}


	public function createService0423(): PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule
	{
		return new PHPStan\Rules\Comparison\WhileLoopAlwaysTrueConditionRule($this->getService('0138'), true, true);
	}


	public function createService0424(): PHPStan\Rules\Exceptions\TooWideFunctionThrowTypeRule
	{
		return new PHPStan\Rules\Exceptions\TooWideFunctionThrowTypeRule($this->getService('0145'));
	}


	public function createService0425(): PHPStan\Rules\Exceptions\TooWideMethodThrowTypeRule
	{
		return new PHPStan\Rules\Exceptions\TooWideMethodThrowTypeRule($this->getService('0182'), $this->getService('0145'));
	}


	public function createService0426(): PHPStan\Rules\Exceptions\TooWidePropertyHookThrowTypeRule
	{
		return new PHPStan\Rules\Exceptions\TooWidePropertyHookThrowTypeRule($this->getService('0182'), $this->getService('0145'));
	}


	public function createService0427(): PHPStan\Rules\TooWideTypehints\TooWideMethodReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideMethodReturnTypehintRule(false);
	}


	public function createService0428(): PHPStan\Rules\Properties\NullsafePropertyFetchRule
	{
		return new PHPStan\Rules\Properties\NullsafePropertyFetchRule;
	}


	public function createService0429(): PHPStan\Rules\Traits\TraitDeclarationCollector
	{
		return new PHPStan\Rules\Traits\TraitDeclarationCollector;
	}


	public function createService0430(): PHPStan\Rules\Traits\TraitUseCollector
	{
		return new PHPStan\Rules\Traits\TraitUseCollector;
	}


	public function createService0431(): PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule
	{
	...
	public function createService0435(): PHPStan\Rules\Functions\ParameterCastableToNumberRule
	{
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/home/jdlxt/__dev/repo/github-tools/cache/phpstan/cache/PHPStan');
	}


	public function createServiceContainer(): Container_74adb65b41
	{
		return $this;
	}
	...
	{
		return new PHPStan\File\ParentDirectoryRelativePathHelper('/home/jdlxt/__dev/repo/github-tools');
	}
	...
	public function createServiceRules__114(): PHPStan\Rules\Cast\EchoRule
	{
		return new PHPStan\Rules\Cast\EchoRule($this->getService('0179'));
	}


	public function createServiceRules__115(): PHPStan\Rules\Cast\InvalidCastRule
	{
		return new PHPStan\Rules\Cast\InvalidCastRule($this->getService('reflectionProvider'), $this->getService('0179'));
	}


	public function createServiceRules__116(): PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule
	{
		return new PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule($this->getService('023'), $this->getService('0179'));
	}


	public function createServiceRules__117(): PHPStan\Rules\Cast\PrintRule
	{
		return new PHPStan\Rules\Cast\PrintRule($this->getService('0179'));
	}


	public function createServiceRules__118(): PHPStan\Rules\Classes\AccessPrivateConstantThroughStaticRule
	{
		return new PHPStan\Rules\Classes\AccessPrivateConstantThroughStaticRule;
	}


	public function createServiceRules__119(): PHPStan\Rules\Classes\MethodTagRule
	{
		return new PHPStan\Rules\Classes\MethodTagRule($this->getService('0135'));
	}
	...
	public function createServiceRules__120(): PHPStan\Rules\Classes\MethodTagTraitRule
	{
		return new PHPStan\Rules\Classes\MethodTagTraitRule($this->getService('0135'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__121(): PHPStan\Rules\Classes\MethodTagTraitUseRule
	{
		return new PHPStan\Rules\Classes\MethodTagTraitUseRule($this->getService('0135'));
	}


	public function createServiceRules__122(): PHPStan\Rules\Classes\PropertyTagRule
	{
		return new PHPStan\Rules\Classes\PropertyTagRule($this->getService('0137'));
	}


	public function createServiceRules__123(): PHPStan\Rules\Classes\PropertyTagTraitRule
	{
		return new PHPStan\Rules\Classes\PropertyTagTraitRule($this->getService('0137'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__124(): PHPStan\Rules\Classes\PropertyTagTraitUseRule
	{
		return new PHPStan\Rules\Classes\PropertyTagTraitUseRule($this->getService('0137'));
	}


	public function createServiceRules__125(): PHPStan\Rules\Classes\MixinTraitRule
	{
		return new PHPStan\Rules\Classes\MixinTraitRule($this->getService('0136'), $this->getService('reflectionProvider'));
	}


	public function createServiceRules__126(): PHPStan\Rules\Classes\MixinTraitUseRule
	{
		return new PHPStan\Rules\Classes\MixinTraitUseRule($this->getService('0136'));
	}


	public function createServiceRules__127(): PHPStan\Rules\Comparison\UsageOfVoidMatchExpressionRule
	{
		return new PHPStan\Rules\Comparison\UsageOfVoidMatchExpressionRule;
	}


	public function createServiceRules__128(): PHPStan\Rules\Constants\ValueAssignedToClassConstantRule
	{
		return new PHPStan\Rules\Constants\ValueAssignedToClassConstantRule;
	}


	public function createServiceRules__129(): PHPStan\Rules\Functions\IncompatibleDefaultParameterTypeRule
	{
	...
	public function createServiceRules__130(): PHPStan\Rules\Functions\IncompatibleArrowFunctionDefaultParameterTypeRule
	{
		return new PHPStan\Rules\Functions\IncompatibleArrowFunctionDefaultParameterTypeRule;
	}


	public function createServiceRules__131(): PHPStan\Rules\Functions\IncompatibleClosureDefaultParameterTypeRule
	{
		return new PHPStan\Rules\Functions\IncompatibleClosureDefaultParameterTypeRule;
	}


	public function createServiceRules__132(): PHPStan\Rules\Generics\ClassAncestorsRule
	{
		return new PHPStan\Rules\Generics\ClassAncestorsRule($this->getService('0151'), $this->getService('0150'));
	}


	public function createServiceRules__133(): PHPStan\Rules\Generics\ClassTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\ClassTemplateTypeRule($this->getService('0154'));
	}


	public function createServiceRules__134(): PHPStan\Rules\Generics\EnumAncestorsRule
	{
		return new PHPStan\Rules\Generics\EnumAncestorsRule($this->getService('0151'), $this->getService('0150'));
	}


	public function createServiceRules__135(): PHPStan\Rules\Generics\EnumTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\EnumTemplateTypeRule;
	}


	public function createServiceRules__136(): PHPStan\Rules\Generics\FunctionTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\FunctionTemplateTypeRule($this->getService('0182'), $this->getService('0154'));
	}


	public function createServiceRules__137(): PHPStan\Rules\Generics\FunctionSignatureVarianceRule
	{
		return new PHPStan\Rules\Generics\FunctionSignatureVarianceRule($this->getService('0155'));
	}


	public function createServiceRules__138(): PHPStan\Rules\Generics\InterfaceAncestorsRule
	{
		return new PHPStan\Rules\Generics\InterfaceAncestorsRule($this->getService('0151'), $this->getService('0150'));
	}


	public function createServiceRules__139(): PHPStan\Rules\Generics\InterfaceTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\InterfaceTemplateTypeRule($this->getService('0154'));
	}
	...
	public function createServiceRules__140(): PHPStan\Rules\Generics\MethodTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\MethodTemplateTypeRule($this->getService('0182'), $this->getService('0154'));
	}


	public function createServiceRules__141(): PHPStan\Rules\Generics\MethodTagTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\MethodTagTemplateTypeRule($this->getService('0153'));
	}


	public function createServiceRules__142(): PHPStan\Rules\Generics\MethodTagTemplateTypeTraitRule
	{
	...
	public function createServiceRules__143(): PHPStan\Rules\Generics\MethodSignatureVarianceRule
	{
		return new PHPStan\Rules\Generics\MethodSignatureVarianceRule($this->getService('0155'));
	}


	public function createServiceRules__144(): PHPStan\Rules\Generics\PropertyVarianceRule
	{
		return new PHPStan\Rules\Generics\PropertyVarianceRule($this->getService('0155'));
	}


	public function createServiceRules__145(): PHPStan\Rules\Generics\TraitTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\TraitTemplateTypeRule($this->getService('0182'), $this->getService('0154'));
	}


	public function createServiceRules__146(): PHPStan\Rules\Generics\UsedTraitsRule
	{
		return new PHPStan\Rules\Generics\UsedTraitsRule($this->getService('0182'), $this->getService('0151'));
	}


	public function createServiceRules__147(): PHPStan\Rules\Methods\CallPrivateMethodThroughStaticRule
	{
		return new PHPStan\Rules\Methods\CallPrivateMethodThroughStaticRule;
	}


	public function createServiceRules__148(): PHPStan\Rules\Methods\IncompatibleDefaultParameterTypeRule
	{
		return new PHPStan\Rules\Methods\IncompatibleDefaultParameterTypeRule;
	}


	public function createServiceRules__149(): PHPStan\Rules\Operators\InvalidBinaryOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidBinaryOperationRule($this->getService('023'), $this->getService('0179'));
	}
	...
	public function createServiceRules__150(): PHPStan\Rules\Operators\InvalidComparisonOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidComparisonOperationRule($this->getService('0179'));
	}


	public function createServiceRules__151(): PHPStan\Rules\Operators\InvalidUnaryOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidUnaryOperationRule($this->getService('0179'));
	}


	public function createServiceRules__152(): PHPStan\Rules\PhpDoc\FunctionConditionalReturnTypeRule
	{
		return new PHPStan\Rules\PhpDoc\FunctionConditionalReturnTypeRule($this->getService('0166'));
	}


	public function createServiceRules__153(): PHPStan\Rules\PhpDoc\MethodConditionalReturnTypeRule
	{
		return new PHPStan\Rules\PhpDoc\MethodConditionalReturnTypeRule($this->getService('0166'));
	}


	public function createServiceRules__154(): PHPStan\Rules\PhpDoc\FunctionAssertRule
	{
		return new PHPStan\Rules\PhpDoc\FunctionAssertRule($this->getService('0167'));
	}


	public function createServiceRules__155(): PHPStan\Rules\PhpDoc\MethodAssertRule
	{
		return new PHPStan\Rules\PhpDoc\MethodAssertRule($this->getService('0167'));
	}


	public function createServiceRules__156(): PHPStan\Rules\PhpDoc\IncompatibleSelfOutTypeRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatibleSelfOutTypeRule($this->getService('0168'), $this->getService('0152'));
	}


	public function createServiceRules__157(): PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule($this->getService('0152'), $this->getService('0168'));
	}


	public function createServiceRules__158(): PHPStan\Rules\PhpDoc\IncompatiblePhpDocTypeRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatiblePhpDocTypeRule($this->getService('0182'), $this->getService('0170'));
	}


	public function createServiceRules__159(): PHPStan\Rules\PhpDoc\IncompatiblePropertyHookPhpDocTypeRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatiblePropertyHookPhpDocTypeRule($this->getService('0182'), $this->getService('0170'));
	}
	...
	public function createServiceRules__160(): PHPStan\Rules\PhpDoc\IncompatiblePropertyPhpDocTypeRule
	{
	...
	public function createServiceRules__161(): PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule($this->getService('0182'));
	}


	public function createServiceRules__162(): PHPStan\Rules\PhpDoc\IncompatibleParamImmediatelyInvokedCallableRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatibleParamImmediatelyInvokedCallableRule($this->getService('0182'));
	}


	public function createServiceRules__163(): PHPStan\Rules\PhpDoc\VarTagChangedExpressionTypeRule
	{
		return new PHPStan\Rules\PhpDoc\VarTagChangedExpressionTypeRule($this->getService('0171'));
	}


	public function createServiceRules__164(): PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule
	{
		return new PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule($this->getService('0182'), $this->getService('0171'));
	}


	public function createServiceRules__165(): PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule
	{
		return new PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule;
	}


	public function createServiceRules__166(): PHPStan\Rules\Classes\RequireImplementsRule
	{
		return new PHPStan\Rules\Classes\RequireImplementsRule;
	}


	public function createServiceRules__167(): PHPStan\Rules\Classes\RequireExtendsRule
	{
		return new PHPStan\Rules\Classes\RequireExtendsRule;
	}


	public function createServiceRules__168(): PHPStan\Rules\PhpDoc\RequireImplementsDefinitionClassRule
	{
		return new PHPStan\Rules\PhpDoc\RequireImplementsDefinitionClassRule;
	}


	public function createServiceRules__169(): PHPStan\Rules\PhpDoc\RequireExtendsDefinitionClassRule
	{
		return new PHPStan\Rules\PhpDoc\RequireExtendsDefinitionClassRule($this->getService('0384'));
	}
	...
	public function createServiceRules__170(): PHPStan\Rules\PhpDoc\RequireExtendsDefinitionTraitRule
	{
	...
	public function createServiceRules__171(): PHPStan\Rules\Pure\PureFunctionRule
	{
		return new PHPStan\Rules\Pure\PureFunctionRule($this->getService('0178'));
	}


	public function createServiceRules__172(): PHPStan\Rules\Pure\PureMethodRule
	{
		return new PHPStan\Rules\Pure\PureMethodRule($this->getService('0178'));
	}


	public function createServiceRules__173(): PHPStan\Rules\Arrays\ArrayDestructuringRule
	{
		return new PHPStan\Rules\Arrays\ArrayDestructuringRule($this->getService('0179'), $this->getService('0130'));
	}


	public function createServiceRules__174(): PHPStan\Rules\Arrays\ArrayUnpackingRule
	{
		return new PHPStan\Rules\Arrays\ArrayUnpackingRule($this->getService('026'), $this->getService('0179'));
	}


	public function createServiceRules__175(): PHPStan\Rules\Arrays\IterableInForeachRule
	{
		return new PHPStan\Rules\Arrays\IterableInForeachRule($this->getService('0179'));
	}


	public function createServiceRules__176(): PHPStan\Rules\Arrays\OffsetAccessAssignmentRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessAssignmentRule($this->getService('0179'));
	}


	public function createServiceRules__177(): PHPStan\Rules\Arrays\OffsetAccessAssignOpRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessAssignOpRule($this->getService('0179'));
	}


	public function createServiceRules__178(): PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule($this->getService('0179'));
	}


	public function createServiceRules__179(): PHPStan\Rules\Arrays\UnpackIterableInArrayRule
	{
		return new PHPStan\Rules\Arrays\UnpackIterableInArrayRule($this->getService('0179'));
	}
	...
	public function createServiceRules__180(): PHPStan\Rules\Exceptions\ThrowExprTypeRule
	{
		return new PHPStan\Rules\Exceptions\ThrowExprTypeRule($this->getService('0179'));
	}


	public function createServiceRules__181(): PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule
	{
		return new PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule($this->getService('0148'));
	}


	public function createServiceRules__182(): PHPStan\Rules\Functions\ClosureReturnTypeRule
	{
		return new PHPStan\Rules\Functions\ClosureReturnTypeRule($this->getService('0148'));
	}


	public function createServiceRules__183(): PHPStan\Rules\Functions\ReturnTypeRule
	{
		return new PHPStan\Rules\Functions\ReturnTypeRule($this->getService('0148'));
	}


	public function createServiceRules__184(): PHPStan\Rules\Generators\YieldTypeRule
	{
		return new PHPStan\Rules\Generators\YieldTypeRule($this->getService('0179'));
	}


	public function createServiceRules__185(): PHPStan\Rules\Methods\ReturnTypeRule
	{
		return new PHPStan\Rules\Methods\ReturnTypeRule($this->getService('0148'));
	}


	public function createServiceRules__186(): PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule
	{
		return new PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule($this->getService('0179'));
	}


	public function createServiceRules__187(): PHPStan\Rules\Properties\GetNonVirtualPropertyHookReadRule
	{
		return new PHPStan\Rules\Properties\GetNonVirtualPropertyHookReadRule;
	}


	public function createServiceRules__188(): PHPStan\Rules\Properties\ReadOnlyPropertyAssignRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyPropertyAssignRule($this->getService('0177'), $this->getService('0109'));
	}


	public function createServiceRules__189(): PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRule($this->getService('0177'), $this->getService('0109'));
	}
	...
	public function createServiceRules__190(): PHPStan\Rules\Properties\ReadOnlyPropertyAssignRefRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyPropertyAssignRefRule($this->getService('0177'));
	}


	public function createServiceRules__191(): PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRefRule
	{
		return new PHPStan\Rules\Properties\ReadOnlyByPhpDocPropertyAssignRefRule($this->getService('0177'));
	}


	public function createServiceRules__192(): PHPStan\Rules\Properties\SetNonVirtualPropertyHookAssignRule
	{
		return new PHPStan\Rules\Properties\SetNonVirtualPropertyHookAssignRule;
	}


	public function createServiceRules__193(): PHPStan\Rules\Properties\TypesAssignedToPropertiesRule
	{
		return new PHPStan\Rules\Properties\TypesAssignedToPropertiesRule($this->getService('0179'), $this->getService('0177'));
	}


	public function createServiceRules__194(): PHPStan\Rules\Variables\ParameterOutAssignedTypeRule
	{
		return new PHPStan\Rules\Variables\ParameterOutAssignedTypeRule($this->getService('0179'));
	}


	public function createServiceRules__195(): PHPStan\Rules\Variables\ParameterOutExecutionEndTypeRule
	{
		return new PHPStan\Rules\Variables\ParameterOutExecutionEndTypeRule($this->getService('0179'));
	}


	public function createServiceRules__196(): PHPStan\Rules\Variables\VariableCloningRule
	{
		return new PHPStan\Rules\Variables\VariableCloningRule($this->getService('0179'));
	}


	public function createServiceRules__197(): PHPStan\Rules\Arrays\DeadForeachRule
	{
		return new PHPStan\Rules\Arrays\DeadForeachRule;
	}


	public function createServiceRules__198(): PHPStan\Rules\DeadCode\CallToConstructorStatementWithoutImpurePointsRule
	{
		return new PHPStan\Rules\DeadCode\CallToConstructorStatementWithoutImpurePointsRule;
	}


	public function createServiceRules__199(): PHPStan\Rules\DeadCode\CallToFunctionStatementWithoutImpurePointsRule
	{
	...
	public function createServiceRules__200(): PHPStan\Rules\DeadCode\CallToMethodStatementWithoutImpurePointsRule
	{
		return new PHPStan\Rules\DeadCode\CallToMethodStatementWithoutImpurePointsRule;
	}


	public function createServiceRules__201(): PHPStan\Rules\DeadCode\CallToStaticMethodStatementWithoutImpurePointsRule
	{
		return new PHPStan\Rules\DeadCode\CallToStaticMethodStatementWithoutImpurePointsRule;
	}


	public function createServiceRules__202(): PHPStan\Rules\DeadCode\NoopRule
	{
		return new PHPStan\Rules\DeadCode\NoopRule($this->getService('023'));
	}


	public function createServiceRules__203(): PHPStan\Rules\DeadCode\UnreachableStatementRule
	{
		return new PHPStan\Rules\DeadCode\UnreachableStatementRule;
	}


	public function createServiceRules__204(): PHPStan\Rules\DeadCode\UnusedPrivateConstantRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivateConstantRule($this->getService('0164'));
	}


	public function createServiceRules__205(): PHPStan\Rules\DeadCode\UnusedPrivateMethodRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivateMethodRule($this->getService('0165'));
	}


	public function createServiceRules__206(): PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule
	{
		return new PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule;
	}


	public function createServiceRules__207(): PHPStan\Rules\Functions\CallToFunctionStatementWithoutSideEffectsRule
	{
		return new PHPStan\Rules\Functions\CallToFunctionStatementWithoutSideEffectsRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__208(): PHPStan\Rules\Functions\UselessFunctionReturnValueRule
	{
		return new PHPStan\Rules\Functions\UselessFunctionReturnValueRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__209(): PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule
	{
	...
	public function createServiceRules__210(): PHPStan\Rules\Methods\CallToMethodStatementWithoutSideEffectsRule
	{
		return new PHPStan\Rules\Methods\CallToMethodStatementWithoutSideEffectsRule($this->getService('0179'));
	}


	public function createServiceRules__211(): PHPStan\Rules\Methods\CallToStaticMethodStatementWithoutSideEffectsRule
	{
	...
	public function createServiceRules__212(): PHPStan\Rules\Methods\NullsafeMethodCallRule
	{
	...
	public function createServiceRules__215(): PHPStan\Rules\TooWideTypehints\TooWideFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideFunctionReturnTypehintRule;
	}


	public function createServiceRules__216(): PHPStan\Rules\TooWideTypehints\TooWideFunctionParameterOutTypeRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideFunctionParameterOutTypeRule($this->getService('0181'));
	}


	public function createServiceRules__217(): PHPStan\Rules\TooWideTypehints\TooWideMethodParameterOutTypeRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideMethodParameterOutTypeRule($this->getService('0181'));
	}


	public function createServiceRules__218(): PHPStan\Rules\TooWideTypehints\TooWidePropertyTypeRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWidePropertyTypeRule($this->getService('0175'), $this->getService('0177'));
	}


	public function createServiceRules__219(): PHPStan\Rules\Traits\NotAnalysedTraitRule
	{
	...
	public function createServiceRules__220(): PHPStan\Rules\DateTimeInstantiationRule
	{
		return new PHPStan\Rules\DateTimeInstantiationRule;
	}


	public function createServiceRules__221(): PHPStan\Rules\Functions\CallUserFuncRule
	{
		return new PHPStan\Rules\Functions\CallUserFuncRule($this->getService('reflectionProvider'), $this->getService('0146'));
	}


	public function createServiceRules__222(): PHPStan\Rules\Functions\ParameterCastableToStringRule
	{
	...
	public function createServiceRules__223(): PHPStan\Rules\Functions\ImplodeParameterCastableToStringRule
	{
	...
	public function createServiceRules__224(): PHPStan\Rules\Functions\SortParameterCastableToStringRule
	{
	...
	public function createServiceRules__225(): PHPStan\Rules\Regexp\RegularExpressionQuotingRule
	{
		return new PHPStan\Rules\Regexp\RegularExpressionQuotingRule($this->getService('reflectionProvider'), $this->getService('0276'));
	}


	public function createServiceRules__226(): PHPStan\Rules\Constants\MissingClassConstantTypehintRule
	{
		return new PHPStan\Rules\Constants\MissingClassConstantTypehintRule($this->getService('0162'));
	}


	public function createServiceRules__227(): PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule($this->getService('0162'));
	}


	public function createServiceRules__228(): PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule($this->getService('0162'));
	}


	public function createServiceRules__229(): PHPStan\Rules\Methods\MissingMethodParameterTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodParameterTypehintRule($this->getService('0162'));
	}
	...
	public function createServiceRules__230(): PHPStan\Rules\Methods\MissingMethodReturnTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodReturnTypehintRule($this->getService('0162'));
	}


	public function createServiceRules__231(): PHPStan\Rules\Methods\MissingMethodSelfOutTypeRule
	{
		return new PHPStan\Rules\Methods\MissingMethodSelfOutTypeRule($this->getService('0162'));
	}


	public function createServiceRules__232(): PHPStan\Rules\Properties\MissingPropertyTypehintRule
	{
		return new PHPStan\Rules\Properties\MissingPropertyTypehintRule($this->getService('0162'));
	}
	...
	{
		return new PHPStan\File\SimpleRelativePathHelper('/home/jdlxt/__dev/repo/github-tools');
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludePaths' => ['analyseAndScan' => ['/home/jdlxt/__dev/repo/github-tools/php/vendor'], 'analyse' => []],
			'level' => 9,
			'paths' => ['/home/jdlxt/__dev/repo/github-tools/php'],
			'exceptions' => [
				'implicitThrows' => true,
			...
			'resultCachePath' => '/home/jdlxt/__dev/repo/github-tools/cache/phpstan/resultCache.php',
			...
			'__validate' => true,
			'tmpDir' => '/home/jdlxt/__dev/repo/github-tools/cache/phpstan',
			'debugMode' => true,
			'productionMode' => false,
			'tempDir' => '/home/jdlxt/__dev/repo/github-tools/cache/phpstan',
			'rootDir' => '/home/jdlxt/.config/composer/vendor/phpstan/phpstan',
			'currentWorkingDirectory' => '/home/jdlxt/__dev/repo/github-tools',
			...
			'composerAutoloaderProjectPaths' => ['/home/jdlxt/.config/composer'],
