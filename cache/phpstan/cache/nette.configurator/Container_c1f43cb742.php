...
// source: phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level8.neon
...
class Container_c1f43cb742 extends _PHPStan_e140197a0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService061(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_c1f43cb742 $container)
			{
	...
	{
		return new PHPStan\Rules\RuleLevelHelper($this->getService('reflectionProvider'), true, false, true, false, false, false);
	}
	...
	public function createServiceContainer(): Container_c1f43cb742
	{
		return $this;
	}
