...
// source: phar:///home/jdlxt/.config/composer/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon
...
class Container_2af6c030e1 extends _PHPStan_e140197a0\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService061(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_2af6c030e1 $container)
			{
	...
	{
		return new PHPStan\Rules\Functions\CallCallablesRule($this->getService('0146'), $this->getService('0179'), false);
	}
	...
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule($this->getService('0179'), false);
	}
	...
	{
		return new PHPStan\Rules\Generators\YieldFromTypeRule($this->getService('0179'), false);
	}
	...
	public function createServiceContainer(): Container_2af6c030e1
	{
		return $this;
	}
